...
dir_data <- "1_CBC_Recoding" # Where is R List with data
dir_model <- "99_Stan_Code" # Location of Stan Code
dir_draws <- "2_HB_Run/2_Stan_HB_Run/1_Output" # Where Stan stores draws.  Recommend a folder that does not sync
